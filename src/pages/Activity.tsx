...
const FILTER_TABS = [
  ...
  { value: "unread" as FilterType, label: "Unread", icon: "✨" },
  { value: "follow" as FilterType, label: "Follows", icon: "👥" },
  { value: "content" as FilterType, label: "Content", icon: "📝" },
];
    ...
    <div className="min-h-screen px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-purple-500 to-blue-600 rounded-xl p-6 text-white shadow-xl mb-8"
        >
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center">
              ...
              <div className="text-sm opacity-90">Follows</div>
            </div>
            <div className="text-center">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <div className="flex gap-2 flex-wrap bg-white dark:bg-gray-800 p-2 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            {FILTER_TABS.map((tab) => (
              <button
                key={tab.value}
        ...
        <AnimatePresence>
          {unreadCount > 0 && (
            <motion.div
              ...
              className="mb-6"
            >
              <div className="flex items-center justify-between bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-2 border-purple-200 dark:border-purple-700 rounded-xl p-5 shadow-lg">
                ...
                <Button
                  ...
                  variant="secondary"
                  className="bg-white dark:bg-gray-800 text-purple-600 hover:bg-purple-50 dark:hover:bg-gray-700 border-2 border-purple-300"
                  size="sm"
                >
        ...
        {filteredNotifications.length === 0 ? (
          ...
          >
            <div className="bg-white dark:bg-gray-800 rounded-xl p-12 shadow-lg border border-gray-200 dark:border-gray-700">
              <BellIcon className="w-20 h-20 text-gray-400 mx-auto mb-6" />
    ...
    <motion.div
      ...
      className={`
        ...
        ${notification.isRead
          ...
          : "bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-purple-300 dark:border-purple-600 shadow-md"
        }
      `}
    >
