    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="mt-3 text-gray-600 max-w-2xl">
          Organize your links, share ideas, and build your digital brain. Never lose a thought again.
        </p>

        
        <div className="mt-8 overflow-hidden w-full ">
          <div className="flex animate-slide space-x-8">
            <img src="/logos/twitter.png" alt="Twitter" className="h-12" />
            <img src="/logos/youtube.png" alt="YouTube" className="h-12" />
            <img src="/logos/github.png" alt="GitHub" className="h-12" />
            <img src="/logos/slack.png" alt="Slack" className="h-12" />
            <img src="/logos/discord.png" alt="Discord" className="h-12" />
