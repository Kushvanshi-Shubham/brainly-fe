        ...
        >
          <div className="flex items-start justify-between mb-4">
                ...
                {isEditing ? (
                  <div className="space-y-3">
                    <input
                      ...
                      className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent text-gray-900 dark:text-white"
                      placeholder="Collection name"
                    />
                    <textarea
                      value={editDescription}
                      onChange={(e) => setEditDescription(e.target.value.slice(0, 500))}
                      className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent text-gray-900 dark:text-white resize-none"
                    ...
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-sm text-gray-700 dark:text-gray-300">Private collection</span>
                    </label>
                  </div>
                ) : (
                  <>
            ...
            <div className="flex gap-2">
              {isEditing ? (
                <>
                  <Button onClick={handleCancelEdit} variant="ghost" text="Cancel" />
                  <Button onClick={handleSaveEdit} variant="primary" text="Save" />
                </>
              ) : (
                <>
                  <Button onClick={handleEdit} variant="primary" text="Edit" />
                  <Button
        ...
        {collection.content && collection.content.length > 0 ? (
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Start adding content to this collection from your saved items
            </p>
            <Button onClick={() => navigate("/dashboard")} variant="primary" text="Go to Dashboard" />
          </motion.div>
        )}
      </div>
        ...
        <DialogContent>
          ...
          <div className="py-4">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              This will only delete the collection, not the content inside it. This action cannot be undone.
            </p>
